        ...
        $.each(lista, function (ind, elem) {
            ...
            $("<tr>" +
                    ...
                    "<td>" + elem.descripcion + "</td>" +
                         "<td><a title='Modificar' href='./modificarComandos/" + elem.id + "'><img src='../public/img/edit.png'></td>" +
                         "<td><a title='Eliminar' href='./EliminarComando/" + elem.id + "'><img src='../public/img/delete.png'></td>" +
                    "</tr>").appendTo($("#miTabla"));
